    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-secondary text-[17px] max-w-3xl leadin-[30px]"
        >
          Following projects shocases my skills and experience through
          real-world examples of my work. Each project is briefly described with
          links to code repositories and live demos in it. It Reflects my abilty
          to solve complex problems, work with different tecgnologies and manage
